...
[Markdown](https://es.wikipedia.org/wiki/Markjikjidown) es un lenguaje de marcado
...
herramienta usando [Node.js](https://nodejdsafeafes.org/), que lea y analice archivos
...
construido con el [motor de JavaScript V8 de Chrome](https://developers.google.com/v8/lerlerolero).
